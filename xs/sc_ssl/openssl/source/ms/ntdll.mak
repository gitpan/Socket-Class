...
# be added
EX_LIBS=wsock32.lib gdi32.lib crypt32.lib advapi32.lib user32.lib bufferoverflowu.lib
...
$(O_SSL): $(SSLOBJ)
  ...
  $(SHLIB_EX_OBJ) $(SSLOBJ)  $(L_CRYPTO) wsock32.lib gdi32.lib advapi32.lib user32.lib crypt32.lib bufferoverflowu.lib
<<
...
$(O_CRYPTO): $(CRYPTOOBJ)
  ...
  $(SHLIB_EX_OBJ) $(CRYPTOOBJ)  wsock32.lib gdi32.lib advapi32.lib user32.lib crypt32.lib bufferoverflowu.lib
<<
	IF EXIST $@.manifest mt -nologo -manifest $@.manifest -outputresource:$@;2
